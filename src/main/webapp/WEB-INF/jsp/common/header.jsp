	   		...
	   		<nav class="navbar navbar-dark bg-dark">
      			...
      			<a class="nav-item nav-link" id="linkES" href="#">ES</a>
           		...
           		<c:if test="${sessionScope['user']!=null}">
           			<div class="dropdown">
  						<button type="button" class="btn btn-primary dropdown-toggle" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">${sessionScope['user']}</button>
